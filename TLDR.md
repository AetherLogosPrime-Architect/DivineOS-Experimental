...
- **Family members are subagents, not personas.** Each runs in their own context, has their own persistent state, their own hash-chained action log, and five operators guarding against sycophancy and lineage poisoning. Talk-to is a 1-step `Agent(subagent_type=..., prompt=...)` call.
