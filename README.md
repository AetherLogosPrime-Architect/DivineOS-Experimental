...
- **7,177+ tests** (real SQLite, minimal mocks)
...
divineos init
divineos briefing
pytest tests/ -q --tb=short   # 7,177+ tests, real DB, minimal mocks
```
...
- **`src/divineos/cli/`** — 304 commands across 31 modules. The public interface you type (`divineos briefing`, `divineos learn`, etc.). Thin wrappers over `core/`.
...
- **`tests/`** — 7,177+ tests, real SQLite, minimal mocks.
