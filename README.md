...
- **7,529+ tests** (real SQLite, minimal mocks)
...
- **23 Claude Code enforcement hooks**
...
divineos init
divineos briefing
pytest tests/ -q --tb=short   # 7,529+ tests, real DB, minimal mocks
```
...
- **`tests/`** — 7,529+ tests, real SQLite, minimal mocks.
...
- **`.claude/hooks/`** — Claude Code enforcement hooks (23 hooks, shell-level entry points that invoke the consolidated Python hooks).
