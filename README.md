...
- **7,217+ tests** (real SQLite, minimal mocks)
...
divineos init
divineos briefing
pytest tests/ -q --tb=short   # 7,217+ tests, real DB, minimal mocks
```
...
- **`tests/`** — 7,217+ tests, real SQLite, minimal mocks.
...
- **`.claude/hooks/`** — Claude Code enforcement hooks (20 hooks, shell-level entry points that invoke the consolidated Python hooks).
