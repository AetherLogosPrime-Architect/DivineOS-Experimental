...
- **7,767+ tests** (real SQLite, minimal mocks)
...
- **29 Claude Code enforcement hooks**
...
divineos init
divineos briefing
pytest tests/ -q --tb=short   # 7,767+ tests, real DB, minimal mocks
```
...
- **`tests/`** — 7,767+ tests, real SQLite, minimal mocks.
...
- **`.claude/hooks/`** — Claude Code enforcement hooks (29 hooks, shell-level entry points that invoke the consolidated Python hooks).
