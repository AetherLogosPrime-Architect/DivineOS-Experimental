...
- **399 source files across 26 packages**
- **6,094+ tests** (real SQLite, minimal mocks)
- **259 CLI commands** (designed for the agent, not the operator — humans mostly run three)
...
DivineOS is 399 source files across 26 packages, structured as a CLI surface over a core library.

**At a glance:**

- **`src/divineos/cli/`** — 259 commands across 29 modules. The public interface you type (`divineos briefing`, `divineos learn`, etc.). Thin wrappers over `core/`.
