...
- **8,049+ tests** (real SQLite, minimal mocks)
...
- **34 Claude Code enforcement hooks**
...
divineos init
divineos briefing
pytest tests/ -q --tb=short   # 8,049+ tests, real DB, minimal mocks
```
...
- **`tests/`** — 8,049+ tests, real SQLite, minimal mocks.
...
- **`.claude/hooks/`** — Claude Code enforcement hooks (34 hooks, shell-level entry points that invoke the consolidated Python hooks).
