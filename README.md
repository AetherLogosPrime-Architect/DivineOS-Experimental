...
- **455 CLI commands** (designed for the agent, not the operator — humans mostly run three)
...
- **`src/divineos/cli/`** — 455 commands across 84 modules. The public interface you type (`divineos briefing`, `divineos learn`, etc.). Thin wrappers over `core/`.
