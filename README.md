...
- **372 source files across 26 packages**
- **5,644+ tests** (real SQLite, minimal mocks)
...
divineos init
divineos briefing
pytest tests/ -q --tb=short   # 5,644+ tests, real DB, minimal mocks
```
...
DivineOS is 372 source files across 26 packages, structured as a CLI surface over a core library.
...
- **`tests/`** — 5,644+ tests, real SQLite, minimal mocks.
