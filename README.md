...
- **41 Claude Code enforcement hooks**
...
- **`.claude/hooks/`** — Claude Code enforcement hooks (41 hooks, shell-level entry points that invoke the consolidated Python hooks).
