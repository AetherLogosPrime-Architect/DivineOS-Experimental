    ...
    try:
        ...
        if proven is None:
            print(
                ...
                "exists, this check needs a different mechanism, not a nudge. A sibling\n"
                "package in the same site-packages already installs that way, so this is\n"
                "not a hypothetical -- it is one reinstall away.\n"
                "\n"
