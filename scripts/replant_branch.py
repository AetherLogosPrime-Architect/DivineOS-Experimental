...
def main(argv: list[str] | None = None) -> int:
    ...
    if at_risk:
        ...
        if derived:
            ...
            print("    1. regenerate from the named source INTO A DIRECTORY THAT EXISTS")
            print("    2. CONFIRM THE REGENERATION WROTE -- the file's mtime moved, or")
            print("       the generator names the path it wrote. If it wrote nothing,")
            print("       step 3 compares the committed file against ITSELF and always")
            print("       passes. That is not a measurement, it is a tautology, and it")
            print("       is how the author of this hint got it wrong on 2026-09-15.")
            print("    3. only then compare bytes:")
