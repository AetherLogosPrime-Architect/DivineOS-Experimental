...
class TestRenderMenu:
    def test_lists_every_rest_option(self, marker_paths: Path):
...
class TestOfferCycle:
    ...
    def test_valid_handshake_records_and_returns_menu(self, marker_paths: Path):
        ...
        # Was `== 11`. Same cause as the count above: the option list changed
        # after this was written. What matters is that the record holds the
        # whole menu, not that the menu is a particular size.
        from divineos.core.rest import REST_TASKS
