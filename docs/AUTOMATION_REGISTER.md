...
| `carry-aletheia-across.sh` | 2026-09-22 | Carry anything of Aletheia's from Andrew's downloads into the shared folder, |
...
| `letter-monitor-health-surface.sh` | 2026-09-22 | Session-init child — say out loud whether the letter monitor is delivering. |
...
| `open-corrections-surface.sh` | 2026-09-22 | surface the 3 most recent OPEN Andrew- |
