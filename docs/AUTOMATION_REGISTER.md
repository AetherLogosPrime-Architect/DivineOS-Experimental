...
**127 automations — 113 wired, 14 switched off.**
...
| `degraded-detector-gate.sh` | 2026-09-14 | SUPERSEDED 2026-09-08 by the router. The decision now lives in |
| `detect-theater.sh` | 2026-09-14 | SUPERSEDED 2026-09-08 by the router. The decision now lives in |
...
| `doorbell-post-tool-use.sh` | 2026-09-14 | PostToolUse doorbell. One of seven. All judgment lives in the OS. |
...
| `doorbell-pre-tool-use.sh` | 2026-09-14 | PreToolUse doorbell. One of seven. All judgment lives in the OS. |
...
| `circle-first-compose-prime.sh` | 2026-09-14 | compose-start prime for circle-FIRST discipline. |
...
| `ear-surface.sh` | 2026-09-14 | UserPromptSubmit + SessionStart hook — auto-surface unseen queue items and |
...
| `close-reach-detector.sh` | 2026-09-14 | SUPERSEDED 2026-09-08 by the router. The decision now lives in |
| `compaction-reach-detector.sh` | 2026-09-14 | SUPERSEDED 2026-09-08 by the router. The decision now lives in |
...
| `detect-correction.sh` | 2026-09-14 | SUPERSEDED 2026-09-08 by the router. The decision now lives in |
| `detect-hedge.sh` | 2026-09-14 | SUPERSEDED 2026-09-08 by the router. The decision now lives in |
