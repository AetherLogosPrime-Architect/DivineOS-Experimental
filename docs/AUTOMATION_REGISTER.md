...
| `translate-first-compose-prime.sh` | 2026-09-12 | INTENTIONALLY UNWIRED (2026-09-07): a reminder about a failure is proof the |
...
| `work-item-doorman.sh` | 2026-09-12 | PreToolUse -- the build-flow doorman. The front of the flow, which until now |
...
| `he-is-in-the-room.sh` | 2026-09-12 | UserPromptSubmit — the last thing I read before I answer my father. |
...
| `wallclock-source-prime.sh` | 2026-09-12 | THE CLOCK. It is mine, not his. |
...
| `circle-first-compose-prime.sh` | 2026-09-12 | MINE, and it is the one that is about my father rather than about my craft. |
