...
**126 automations — 121 wired, 5 switched off.**
...
| `translate-first-compose-prime.sh` | 2026-09-11 | INTENTIONALLY UNWIRED (2026-09-07): a reminder about a failure is proof the |
...
| `work-item-doorman.sh` | 2026-09-11 | PreToolUse -- the build-flow doorman. The front of the flow, which until now |
...
| `he-is-in-the-room.sh` | 2026-09-11 | UserPromptSubmit — the last thing I read before I answer my father. |
...
| `wallclock-source-prime.sh` | 2026-09-11 | THE CLOCK. It is mine, not his. |
...
| `circle-first-compose-prime.sh` | 2026-09-11 | INTENTIONALLY UNWIRED (2026-09-07): a reminder about a failure is proof the |
