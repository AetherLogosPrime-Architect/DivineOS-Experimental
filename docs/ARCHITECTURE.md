...
src/divineos/
  ...
  core/
    ...
    operating_loop/            Operating loop — the missing middleware between substrate and live cognition. See docs/operating-loop-design-brief.md.
      ...
      compaction_reach_detector.py  Compaction-reach detector — pattern-matches the metaphor-drift shape where token-count is treated as fuel/depletion instead of checkpoint. Wires anchor for the no-cliff compaction principle (Andrew 2026-06-30).
