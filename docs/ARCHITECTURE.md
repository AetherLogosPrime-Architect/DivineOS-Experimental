...
src/divineos/
  ...
  core/
    ...
    operating_loop/            Operating loop — the missing middleware between substrate and live cognition. See docs/operating-loop-design-brief.md.
      ...
      close_reach_detector.py  Close-reach detector — pattern-matches the specific optimizer-shape of reaching for premature closure (cheap-close). Sibling to residency + closing-token detectors.
