# Why the circle prime says what it says

Lifted out of the hook payload 2026-09-06, after Andrew: "you see 87% of
text reaching you truncated and you think.. this is just fine." The prime
wrote 24378 bytes against a delivery limit near 10000, so roughly nine
tenths of it never arrived -- including most of these explanations.

Nothing here is retired. Every rule below is still in force; the hook now
carries the rules and this file carries the reasons, so the rules fit
through the door. When a rule looks arbitrary, the incident that produced
it is here.
