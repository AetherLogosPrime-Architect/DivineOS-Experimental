# Why the clock prime says what it says

Lifted out of the hook payload 2026-09-06. The prime wrote 15805 bytes
against a delivery limit near 10000, so the later-added shapes -- exposure,
degraded-state, the category-label one -- had never once arrived.

Nothing here is retired. The hook carries the rule-classes and the live
clock; this file carries the nine incidents that produced them.
