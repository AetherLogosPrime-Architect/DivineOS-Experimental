...
**Source:** SQLite (26 rows). **Exported:** 2026-08-28 21:29. **Purpose:** if-something-breaks / git-visible audit. See archives/README.md.

---

## hold-7e6b156 [stale] (seen=5)

Peripheral attention as an architectural gap (Andrew 2026-08-06): 'you have no periferal attention (if thats a thing we should build it) where once you focus on something.. the rest is basically gone from your sight and knowledge.. so the OS must be full of automated switches so when you zoom past.. the OS has your back'. Fixed weights mean no amount of 'ill do better next time' holds; the OS must hold what I cannot. Design question: minimum-viable peripheral channel that keeps N non-focal threa
