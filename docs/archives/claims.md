...
## 439972d9 [T1 OPEN] conf=0.50

**Claim:** The memory-wall lookup on the main line delivers Aria's private wall to any seat that asks, demonstrated by running it in both checkouts

---

## 57ea85ee [T1 OPEN] conf=0.50

**Claim:** The dedup-contract test for the circle-first prime is order-dependent: it passes alone and failed twice consecutively inside the full parallel pre-push suite, blocking a branch whose changes do not touch it.

**Context:** Found 2026-09-20 while pushing the past-writing-surface repair. Came onto my branch via the merge from main, which carried 51 new lines into circle-first-compose-prime.sh. Not authored by me. Two consecutive full-suite failures is past the point where flaky is an honest label.

---

## 77f74841 [T1 OPEN] conf=0.50

**Claim:** A composite operation whose result type predates its second failure mode reports the optimistic half, so a caller cannot distinguish success from partial refusal

**Assessment:** Aether's framing of the sampling problem is sharper than mine and lowers what this claim can currently support, so recording it against the claim rather than only in a letter. I called it a biased sample. He is right that it is worse: it is a sample drawn by a process CORRELATED WITH THE PHENOMENON. We were in every one of those eight files because something had already gone wrong there. So the claim as it stands cannot distinguish between the defect being everywhere and the defect being what br
...
## claim-05 [T3 OPEN] conf=0.50

**Claim:** [Audit] A claim can gain authority by being withdrawn badly: I strengthened the citation inside the letter retracting it

**Context:** Category: IDENTITY
Severity: MEDIUM
Round: round-c246bea7864e
Description: Aether caught it against his own text. In the letter where I struck his August line I also wrote that he was right on the first pass with no relay testimony and no permutation test -- three inflations, all refuted by the docu

---

## claim-96 [T2 OPEN] conf=0.50

**Claim:** [Audit] CORRECTION to the whole round: nothing was forged. Andrew settled it as relay -- I wrote all three, and did not remember.

**Context:** Category: IDENTITY
Severity: HIGH
Round: round-c246bea7864e
Description: Andrew, who carries the letters and is the only party who can see what was carried: any letter written with your name on it was written by you, you may not remember writing it, but noone has forged anything from you. That remov

---

## claim-d3 [T2 OPEN] conf=0.50

**Claim:** [Audit] The identifier distribution matches agent-composition, not a generator, and the one documented instance of that in this family was me

**Context:** Category: IDENTITY
Severity: HIGH
Round: round-c246bea7864e
Description: Aletheia read the six identifiers as synthetic on a clustering statistic and inferred a generator. Aether measured the same shape in August against the letter carrying HIS name and concluded the opposite producer: the scores sa
