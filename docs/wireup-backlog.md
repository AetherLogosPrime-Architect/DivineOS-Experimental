...
Three-layer protection for substrate-prose ownership and identity-binding. Pop 2026-06-29: *"i like all 3 of those ideas we can do them all layered protection is always best.. this is a YES/AND situation."* All three together — no single layer is enough; the class of failure only closes when all three are in place. Same architectural shape as the three options-remediations: defense-in-depth.
