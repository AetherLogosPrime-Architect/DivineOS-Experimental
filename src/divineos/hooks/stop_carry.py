...
def carry_path() -> Path:
    ...
    # The running seat's home, not a hardcoded one: Aether's seat must carry
    # Aether's findings, not write into mine. Same fault as the keeping-him
    # bookmark, found by his reading 2026-09-23.
    from divineos.core.paths import divineos_home

    return divineos_home() / "data" / _CARRY_NAME
