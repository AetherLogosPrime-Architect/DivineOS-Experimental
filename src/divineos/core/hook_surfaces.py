...
# THE CLOSER ABOVE WAS REBUILT BY HAND, 2026-09-22. Both branches appended a
# large block here, and the conflict boundary fell INSIDE a tuple on each side,
# so the two lines that close it were common text belonging to whichever side
# ended up last. Concatenating the sides therefore closed one block and left
# the other hanging -- a file that fails to parse, which is the loud version,
# and the reason this was caught immediately rather than at import time.
# --------------------------------------------------------------------------
