...
def format_for_briefing(max_recent: int = 5, active_text: str | None = None) -> str:
    ...
    The full list goes in ``divineos recall-explorations``. This surface is a pointer,
    ...
    lines.append('  Browse all: divineos recall-explorations   |   Search: divineos ask "topic"')
    return "\n".join(lines) + "\n"
