...
def refusal(waiting: list[his_asks.Kept], opening: str) -> str:
    ...
    lines += [
        ...
        "              reports is a signal about that report, not an empty turn. It also",
        "              needs what we sent right before: the door keeps it when it can,",
        '              otherwise quote it with --preceded-by "...".',
        "",
