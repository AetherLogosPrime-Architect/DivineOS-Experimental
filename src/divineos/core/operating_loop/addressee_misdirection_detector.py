...
ADDRESSEE_AFFIRMATION = (
    ...
    "their content belongs. The operator gets the architectural-summary "
    "shape; the family-member gets the relational-content shape. Don't "
    "conflate the channels. Scope: family-member subagents only — bash "
    "and other tool results don't trigger this rule."
)
