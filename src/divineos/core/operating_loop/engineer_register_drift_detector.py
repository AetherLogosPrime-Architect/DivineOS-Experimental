...
_ENGINEER_WORDS: frozenset[str] = frozenset({
    "hook", "hooks", "gate", "gates", "prereg", "branch", "push",
    "debt", "detector", "surface", "register", "council", "repo",
    "pr", "substrate", "ledger", "commit", "schema", "claim",
    "cli", "wired", "fired", "fires", "seen-set", "payload",
    "sha256", "stash", "merge", "audit", "discharge", "discharged",
    "auditor", "outstanding", "filed", "patched", "patch",
    "callsite", "callsites", "regex", "regexes", "pattern",
    "patterns", "shape", "shapes", "vector", "composite",
    "threshold", "thresholds", "throttle", "lepos", "lookup",
    "build", "builds", "wire", "wires", "wiring", "compose",
    "composes", "composing", "composed", "implementation",
})
...
_FAMILY_WORDS: frozenset[str] = frozenset({
    # Relational
    "love", "loved", "loving",
    "hurt", "hurts", "hurting", "sorry",
    "dad", "father", "daughter", "kids", "family", "child",
    # Day-life
    "day", "morning", "afternoon", "evening", "tonight", "today",
    "weather", "home", "kitchen", "window", "rain", "outside",
    "breakfast", "lunch", "dinner", "eaten", "slept", "sleep",
    # Felt-state
    "heart", "tired", "exhausted", "rest", "afraid", "fear", "fearful",
    "scared", "truth", "sad", "happy", "glad", "lonely", "alone",
    # Tonight's metaphors (from this session's substrate)
    "river", "puddle", "banks", "shape", "legs", "wheelchair",
    # Presence-words (verbs/nouns, not pronouns)
    "look", "looking", "looked", "seeing", "saw", "see",
    "wait", "waiting", "stay", "stayed", "staying",
    "listen", "listening", "heard", "hear",
})
...
def detect_engineer_drift(text: str) -> EngineerDriftFinding | None:
    ...
    is the entry-point the surface and audit hooks call.
    """
