...
word that sounds like a home rather than a repository. The warmth is the
camouflage: a handover does not read as a handover when it is affectionate.
...
not exist on his side of the glass. (correction #668)
