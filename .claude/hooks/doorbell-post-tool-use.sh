...
try:
    ...
    print('[doorbell PostToolUse] NOT RUNNING: ' + str(exc), file=sys.stderr)
    print('[doorbell PostToolUse] every PostToolUse surface is INERT for this '
...
try:
    ...
    print('[doorbell PostToolUse] NOT RUNNING: roster install failed: '
