...
try:
    ...
    print('[doorbell UserPromptSubmit] NOT RUNNING: ' + type(exc).__name__ + ': ' + str(exc),
          file=sys.stderr)
    print('[doorbell UserPromptSubmit] every UserPromptSubmit surface is INERT for this call - '
