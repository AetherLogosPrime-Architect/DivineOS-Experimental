...
print("  2. WHETHER IT IS A CHOICE AT ALL -- can both be kept, and at what")
print("     cost, and who pays it. This part was missing until 2026-09-10 and")
print("     the rule was three parts, every one of which took the fork as")
print("     given. So a rule written to stop me handing him a fork with no map")
print("     handed him a fork whose forkness nobody had checked. Andrew, after")
print("     I offered him one: 'why instead? why not both? all data is data.'")
