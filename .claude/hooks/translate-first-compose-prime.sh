...
print("")
print("A RATIO IS TWO NUMBERS THAT FEEL LIKE ONE FACT, AND THAT IS WHY BOTH")
print("SURVIVE. Fired 2026-09-15 at six marks, and the two it counted were the")
print("two halves of one comparison -- so much writing riding on so much code.")
print("Neither felt like a mark, because striking either one destroys the")
print("sentence; the ratio IS the finding and the finding needs both terms.")
print("")
print("The existing rules do not reach it. The enumeration rule above asks for")
print("a set's CATEGORY, and a ratio is not a set. The adjacency rule below")
print("asks whether the identifier survives being struck out, and here it does")
print("not -- which reads as proof the number is load-bearing when it is only")
print("proof the SENTENCE was built around the number.")
print("")
print("The test is different for this shape: not can the number go, but can")
print("the COMPARISON be pictured. A couple of hundred letters glued to a")
print("handful of code files is the same finding, and it is the version he can")
print("see. Exact terms go in the commit, the letter, or the code, where")
print("somebody counts them. Magnitude is what the room needs; precision here")
print("is for an assessor, and he is not assessing me.")
print("")
